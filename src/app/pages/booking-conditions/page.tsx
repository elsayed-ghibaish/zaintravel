  ...
  return (
    <>
      <div className="container mx-auto lg:w-3/5 sm:w-full my-8 p-10 bg-gray-100 rounded-md">
        ...
        <ol className="list-decimal ml-8 text-gray-900">
          <span className="block">يتم الالغاء برسالة على واتس اب على الرقم 01012930010 قبل السادسة مساءً</span>
          <span className="block">الالغاء بعد السادسة : اى إلغاء بعد الساعة 6 مساءً فى اليوم السابق للرحلة يتم الاتى</span>
          ...
          <li>فى حال عدم الدفع لن يتم قبول حجزك مرة اخرى حتى دفع المبالغ المستحقة</li>
