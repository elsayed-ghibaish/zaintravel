    ...
    <>
      <div className="max-w-md mx-auto mt-20 container mb-10 p-5">
        ...
        <p className="text-gray-900 mt-5 mb-5">
          التعامل مع الاقتراحات والشكاوي المقدمة من قبل متلقي الخدمة بهدف
          التواصل معهم ومعرفة أسباب عدم رضاهم عن الخدمات والاجراءات المقدمة لهم
          بالاضافة إلى الاستفادة من اقتراحاتهم وأفكارهم من أجل التحسين والتطوير
          على الخدمات باستمرار.
        </p>
