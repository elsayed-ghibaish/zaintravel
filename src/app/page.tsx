      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pb-16 pt-20 text-center lg:pt-32">
        <h1 className="mx-auto max-w-4xl font-tajawal text-3xl font-medium tracking-tight text-slate-900 sm:text-4xl">
          ...
          <span className="relative whitespace-nowrap text-red-600">
            ...
            <span className="relative">الزين تراڤل</span>
          </span>{" "}
          {/* */}للرحلات و النقل السياحي
        </h1>
        <p className="mx-auto mt-6 max-w-2xl text-lg tracking-tight text-slate-700">
          اكتشف عالمًا جديدًا من السفر والمغامرات مع الزين تراڤل ! 🌍✈️ انضم
          إلينا في رحلة لا تُنسى حيث نقدم لك أفضل الخدمات في مجال النقل
          والسياحة، من الأماكن الساحرة إلى اللحظات الاستثنائية، دعنا نكون رفيقك
          في كل خطوة.
        </p>
